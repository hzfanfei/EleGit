...
Write-Host "Sync CosyVoice catalog from Volc list + generate prompt wavs (needs .env Volc keys):"
Write-Host "  node sync-cosyvoice-catalog-from-volc.mjs"
Write-Host "  node generate-cosyvoice-prompts-volc.mjs"
